...
import {TeamsModel} from '../../../shared/models/teams.model';
...
export class TeamService {
    ...
    sendStockNotification(description: string, notificationCode: string, material: string) {
        const params = new HttpParams()
            .set('description', description)
            .set('notificationCode', notificationCode)
            .set('materialName', material);
        return this.http.post(`${this.endpoint}/send-stock-notification`, params);
    }
}
