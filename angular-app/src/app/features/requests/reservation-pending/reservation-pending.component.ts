...
import {GuideStateComponent} from '../../../shared/components/guide-state/guide-state.component';
        ...
        this.route.queryParams.subscribe(params => {
            ...
            if (user.getRoles().includes('ADMIN')) {
                ...
                this.stockService.getDeposits().subscribe({
                    next: data => {
                        const filtered = data.filter(d => !d.isTruck);
                        this.deposits = filtered.map(d =>
                            ({
                                depositId: d.idDeposit,
                                        ...
                                        isEqual(
                                            {
                                                ...
                                                order: {
                                                    ...
                                                    materialId: orderObj.materialId,
                                                    quantity: orderObj.requestQuantity
                                                }
                                            },
                                            reply
                                        )
