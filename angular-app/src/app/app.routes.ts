...
export const routes: Routes = [
  ...
  // start paths stock
  {
    ...
    canActivate: [AuthGuard],
    data: { role: ['ADMIN', 'ESTOQUISTA', 'ESTOQUISTA-CHEFE', 'ANALISTA'], path: 'estoque' },
  },
  {
    path: 'estoque/grupos',
    loadComponent: () => import('./stock/groups/groups.component').then(m => m.GroupsComponent),
    canActivate: [AuthGuard],
    data: { role: ['ADMIN', 'ESTOQUISTA', 'ESTOQUISTA-CHEFE'], path: 'estoque' },
  },
  {
    path: 'estoque/tipos',
  ...
  },
  {
    ...
    canActivate: [AuthGuard],
    data: { role: ['ADMIN', 'ESTOQUISTA-CHEFE'], path: 'estoque' },
  },
  {
  ...
  },
  {
    ...
    canActivate: [AuthGuard],
    data: { role: ['ADMIN', 'ANALISTA', 'ESTOQUISTA'], path: 'estoque' },
  },
  {
    ...
    canActivate: [AuthGuard],
    data: { role: ['ADMIN', 'ESTOQUISTA'], path: 'estoque' },
  },
