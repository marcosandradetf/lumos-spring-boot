package com.lumos.lumosspring.premeasurement.service;

import com.lumos.lumosspring.contract.repository.ContractRepository;
import com.lumos.lumosspring.premeasurement.dto.PreMeasurementRequest;
...
import com.lumos.lumosspring.premeasurement.repository.*;
    ...
    public ResponseEntity<?> saveStreetPhotos(List<MultipartFile> photos) {
        for (MultipartFile photo : photos) {
            try {
                ...
                // Salva a nova foto
                String photoUri = s3Service.uploadFile(photo, "photos/pre_measurement", "ponto", Utils.getCurrentTenantId());
