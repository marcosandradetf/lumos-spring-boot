...
import com.lumos.lumosspring.premeasurement.dto.*;
...
@Service
public class PreMeasurementViewRepository {
    private final NamedParameterJdbcTemplate namedJdbc;

    public PreMeasurementViewRepository(NamedParameterJdbcTemplate namedJdbc) {
        this.namedJdbc = namedJdbc;
    }

    public PreMeasurementResponse findById(Long preMeasurementID) {
        ...
        return namedJdbc.queryForObject(
                ...
                (rs, rowNum) -> {
                    ...
                    List<PreMeasurementStreetResponse> streets = namedJdbc.query(
                            """
                            ...
                            (rs2, rowNum2) -> {
                                ...
                                List<PreMeasurementStreetItemResponse> items = namedJdbc.query(
                                        streetItemSql,
                                        Map.of("streetId", streetId),
                                        (rs3, rowNum3) -> new PreMeasurementStreetItemResponse(
                                ...
                                return new PreMeasurementStreetResponse(
                                        rowNum2 + 1,
                                        streetId,
                    ...
                    return new PreMeasurementResponse(
                            preMeasurementID,
    ...
    public List<ListPreMeasurementResponse> findAllByStatus(String status) {
        ...
        return namedJdbc.query(
                ...
                (rs, _) -> {
                    ...
                    return new ListPreMeasurementResponse(
