...
import com.lumos.lumosspring.stock.materialstock.dto.SupplierDTO;
import com.lumos.lumosspring.stock.materialstock.dto.SupplierResponse;
...
import com.lumos.lumosspring.stock.materialstock.service.MaterialStockService;
...
public class MaterialStockController {
    ...
    public MaterialStockController(StockMovementService stockMovementService, MaterialStockService materialStockService, SupplierRepository supplierRepository, Util util) {
    ...
    public ResponseEntity<?> getStock(
        ...
        return materialStockService.getMaterialsForMaintenance(uuid, teamId);
    }
    ...
    public ResponseEntity<StockQueryRepository.StockResponse> sendOrder(
        ...
        return materialStockService.saveOrder(uuid, order);
    }
    ...
    public ResponseEntity<?> getStockMaterialForLinking(
            @PathVariable String linking,
            @PathVariable String type,
            @PathVariable Long teamId
    ) {
        return materialStockService.getStockMaterialForLinking(
                linking,
                type,
                teamId
        );
