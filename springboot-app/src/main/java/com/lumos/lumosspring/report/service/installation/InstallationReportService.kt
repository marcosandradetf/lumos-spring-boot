            ...
            val valuesLines = values.mapIndexed { index, it ->
                """
                    <tr>
                        ...
                        <td style="text-align:right">${Utils.formatMoney(it["unit_price"].asDouble())}</td>
                        <td style="text-align:right">${it["quantity_executed"].asText()}</td>
                        <td style="text-align:right">${Utils.formatMoney(it["total_price"].asDouble())}</td>
                    </tr>
                """.trimIndent()
            }.joinToString("\n")
                ...
                <table class="data-table">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th style="text-align:right">${Utils.formatMoney(values.sumOf { it["total_price"].asDouble() })}</th>
                        </tr>
                    </tfoot>
                </table>
            """.trimIndent()
