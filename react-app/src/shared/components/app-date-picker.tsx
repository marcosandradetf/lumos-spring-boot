...
export function AppDatePicker({
  ...
  useEffect(() => {
    ...
    const frame = requestAnimationFrame(() => setMonth(value));
    ...
    <Popover className="relative">
      {({ open }) => (
        <div ref={containerRef}>
          <AutoScrollOnOpen open={open} enabled={autoScrollOnOpen} targetRef={panelRef} />
          <PopoverButton
            disabled={disabled}
            className={[
            ...
            >
              ...
              <DayPicker
                ...
                classNames={{
                  ...
                  day_button:
                    ['h-9 w-9 rounded-full text-sm text-slate-700',
